...
try
{
    ...
    builder.Services.AddSwaggerGen(options =>
    {
        options.SwaggerDoc("v1", new()
        {
            ...
            Version     = "v1",
            Description = "Real-time fraud detection SaaS platform for Egyptian merchants.",
        });
    });
    ...
    app.MapGet("/health", () => Results.Ok(new { status = "healthy", service = "AegisRadar API", timestamp = DateTime.UtcNow }))
       .WithTags("Health")
       .AllowAnonymous();
