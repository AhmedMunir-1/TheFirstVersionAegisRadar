...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background bg-hero-gradient relative">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-card-gradient border border-border shadow-elevated relative z-10">
