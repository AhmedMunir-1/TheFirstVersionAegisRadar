        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false, defaultValue: "EG"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_MerchantId_IsRead",
                table: "Alerts",
                columns: new[] { "MerchantId", "IsRead" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantSubscriptions_MerchantId_IsActive",
